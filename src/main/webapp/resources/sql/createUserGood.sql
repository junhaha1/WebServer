...
ALTER TABLE USERGOOD DROP CONSTRAINT usergood_member_fk2;

ALTER TABLE USERGOOD ADD CONSTRAINT usergood_member_fk FOREIGN KEY(ID) REFERENCES MEMBER(ID) ON UPDATE CASCADE;